    ...
    >
      ...
      <PopoverContent>
        <div className="flex flex-col items-start justify-center gap-2 rounded-md overflow-hidden bg-slate-100">
          <h5 className="w-full font-semibold text-lg text-slate-700 bg-red-100 text-start px-2 py-3 italic">
            Are you sure?
          </h5>
          <p className="w-full font-regural text-md text-slate-600 text-start px-2 py-2 mb-2">
            Are you sure that you want to remove this file? If you delete the
            file then it won't be displayed on your site.
          </p>
          <div className="w-full px-2">
            <p className="w-full pl-5 py-2 bg-red-50 font-regural text-sm text-red-400 italic border border-red-200 rounded-sm">
